        ...
        if (sValue != null && sValue.endsWith("%")) {
            ...
            try {
                ...
                if (percent < 0 || percent > 100) {
                    ...
                    throw new RuntimeException(LoggerMessageFormat.format("percentage should be in [0-100], got [{}]", percentAsString));
                }
                ...
                throw new RuntimeException(LoggerMessageFormat.format("failed to parse [{}] as a double", percentAsString), e);
            }
        } else {
