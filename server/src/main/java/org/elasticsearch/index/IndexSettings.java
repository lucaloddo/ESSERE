...
public final class IndexSettings {
    ...
    public synchronized boolean updateIndexMetadata(IndexMetadata indexMetadata) {
        ...
        final String newUUID = newSettings.get(IndexMetadata.SETTING_INDEX_UUID, INDEX_UUID_NA_VALUE);
        if (newUUID.equals(getUUID()) == false) {
            throw new IllegalArgumentException("uuid mismatch on settings update expected: " + getUUID() + " but was: " + newUUID);
        }
        final String newRestoreUUID = newSettings.get(IndexMetadata.SETTING_HISTORY_UUID, INDEX_UUID_NA_VALUE);
        final String restoreUUID = this.settings.get(IndexMetadata.SETTING_HISTORY_UUID, INDEX_UUID_NA_VALUE);
